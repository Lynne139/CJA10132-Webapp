...
<table>
	...
	<tr>
		<td>房型名稱:</td>
		<td><input type="TEXT" name="roomTypeName" value="<%=roomTypeVO.getRoomTypeName()%>" size="45"/></td>
	</tr>
	<tr>
		<td>房型數量:</td>
		<td><input type="TEXT" name="roomTypeAmount"   value="<%=roomTypeVO.getRoomTypeAmount()%>" size="45"/></td>
	</tr>
	<tr>
		<td>房型介紹:</td>
		<td><input type="TEXT"  name="roomTypeContent" value="<%=roomTypeVO.getRoomTypeContent()%>" size="45"/></td>
	</tr>
	<tr>
		<td>房型狀態:</td>
		<td><input type="TEXT" name="roomSaleStatus"   value="<%=roomTypeVO.getRoomSaleStatus()%>" size="45"/></td>
	</tr>
	<tr>
		<td>房型金額:</td>
		<td><input type="TEXT" name="roomTypePrice"  value="<%=roomTypeVO.getRoomTypePrice()%>" size="45"/></td>
	</tr>
