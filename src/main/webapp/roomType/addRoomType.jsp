...
<title>房型資料新增 - addRoomType.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>房型資料新增 - addRoomType.jsp</h3></td><td>
...
<table>
	...
	<tr>
		<td>房型名稱:</td>
		<td><input type="TEXT" name="roomTypeName" value="<%= (roomTypeVO==null)? "奢華雙人房" : roomTypeVO.getRoomTypeName()%>" size="45"/></td>
	</tr>
	<tr>
		<td>房型數量:</td>
		<td><input type="TEXT" name="roomTypeAmount"   value="<%= (roomTypeVO==null)? "10" : roomTypeVO.getRoomTypeAmount()%>" size="45"/></td>
	</tr>
	<tr>
		<td>房型介紹:</td>
		<td><input type="TEXT" name="roomTypeContent" value="<%= (roomTypeVO==null)? "擁有私人泳池與沙灘，無敵海景盡收眼底" : roomTypeVO.getRoomTypeContent()%>" size="45"/></td>
	</tr>
	<tr>
		<td>房型狀態:</td>
