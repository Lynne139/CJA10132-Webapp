...
<table id="table-1">
	<tr><td>
		 <h3>房間資料修改 - update_room_input.jsp</h3>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="roomId" value="<%=roomVO.getRoomId()%>" size="45"/></td>
	</tr>
	...
	<tr>
		<td>住客姓名:</td>
		<td><input type="TEXT" name="roomGuestName"   value="<%=roomVO.getRoomGuestName()%>" size="45"/></td>
	</tr>
	<tr>
		<td>上下架狀態:</td>
