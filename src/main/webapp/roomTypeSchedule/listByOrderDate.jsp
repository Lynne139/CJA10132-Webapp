...
<%
    List<RoomTypeScheduleVO> list = (List<RoomTypeScheduleVO>) request.getAttribute("list");
	pageContext.setAttribute("list", list);
%>

<html>
<head>
<title>所有房型資料 - listByOrderDate.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>日期查詢房型預定資料 - listByOrderDate.jsp</h3>
				<h4>
	...
	<c:forEach var="roomTypeScheduleVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
